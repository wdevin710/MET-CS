...
getwd()
set0 <- read.table("readin/ReadMeIn0.txt",
                   header=TRUE)
# specify new seperator
set1 <- read.table("readin/ReadMeIn1.txt",
                   header=TRUE,
                   sep=',')
# Or use read.csv
set1 <- read.csv("readin/ReadMeIn1.txt",
                 header=TRUE)

## # another change of seperator
set2 <- read.table("readin/ReadMeIn2.txt",
                   header=TRUE,
                   sep=';')
# check for missing
set3 <- read.table("readin/ReadMeIn3.txt",
                   header=FALSE,
                   sep=',',
                   na.strings = '')
...
?write.csv
write.csv(myRObject, file="/Users/alizadeh/temp/file.csv", row.names=FALSE)
